...
class TestDTensorRedistributeReturnValue(DTensorContinuousTestBase):
    ...
    _unflatten_orig_param_states() in _optim_utils.py (line 1463), where
    the return value was discarded, causing silently wrong optimizer state
    ...
    def test_redistribute_return_value_must_be_captured(self):
        ...
        self.assertEqual(value._local_tensor.numel(), global_tensor.numel())
